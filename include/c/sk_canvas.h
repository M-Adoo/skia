...
*/
SK_API void sk_c`anvas_draw_picture(sk_canvas_t*, const sk_picture_t*, const sk_matrix_t*,
                                   const sk_paint_t*);

SK_API void sk_canvas_draw_text(sk_canvas_t* ccanvas, const void* text, size_t length, float x,
                                float y, const sk_paint_t* cpaint);
